...
export const es: Dictionary = {
  ...
  shell: {
    ...
    noConversations: "Tus conversaciones con el Director aparecerán aquí.",
  ...
  landing: {
    ...
    pricingText:
      "Un crédito = un segundo de vídeo (Natural en 1080p: 2 créditos por segundo). 3 créditos gratis al registrarte.",
    popular: "Popular",
  ...
  studio: {
    ...
    placeholderDirector: "Háblale de tu vídeo al Director: tu idea, para quién es, qué quieres conseguir…",
    placeholderDirectorBrief: "Ej.: más divertido, añade un plano del producto, versión de 30 s…",
    moreSettings: "Más ajustes",
    modeDirector: "Director",
    modeDirectorHint: "Tu compañero: ideas y un prompt listo para lanzar",
    modeDirect: "Directo",
    ...
    swapVideoHint: "MP4, MOV o WebM · se usan {max} s · una persona bien visible",
    swapSegment: "Fragmento usado ({max} s)",
    swapTarget: "¿A quién reemplazar?",
    swapTargetPlaceholder: "¿A quién reemplazar? ej.: el luchador de pantalón negro (opcional)",
    swapImage: "Personaje",
    swapImageHint: "Personaje de cuerpo entero, de frente, fondo liso: conservará este aspecto",
    ...
    swapKeyframes: "Colocando al personaje en cada plano",
    swapShots: "Rodaje y revisión de los planos",
    swapRedoTitle: "¿Un plano fallido? Rehazlo solo:",
    swapShot: "Plano {n}",
    swapShotFlagged: "Revisar",
    swapRedo: "Rehacer el plano {n} · {cost} {credits}",
    swapping: "Reemplazando al personaje…",
    swapGenjutsuHint: "Unos {minutes} min · encontrarás el vídeo aquí al volver",
    directorStatus: "El Director te ayuda a preparar tu vídeo, tú lo lanzas",
    ...
    briefReady: "Brief del Director",
    briefPrompt: "Prompt para el modo Directo",
    briefToFilm: "Qué grabar para el modo Reemplazar",
    useInDirect: "Usar en modo Directo",
    useInSwap: "Pasar al modo Reemplazar",
    briefApplied: "Listo, te toca lanzarlo",
    copy: "Copiar",
    copied: "Copiado",
    cancel: "Cancelar",
    download: "Descargar",
  ...
  swapEngines: {
    genjutsu: {
      label: "Calidad máx.",
      hint: "Genjutsu · {rate} créditos/s · hasta {max} s, cortes incluidos",
    },
    kling: {
      label: "Económico",
  ...
  creditsPage: {
    ...
    title: "Créditos",
    intro:
      "Un crédito = un segundo de vídeo (Natural en 1080p: 2 créditos por segundo). Paga solo lo que usas, sin suscripción.",
