...
export const es: Dictionary = {
  ...
  creditsPage: {
    ...
    title: "Créditos",
    intro:
      "Calidad máx.: {max} créditos por segundo. Económico: {budget} créditos por segundo. Más {sheet} créditos por vídeo para la ficha del personaje. Paga solo lo que usas, sin suscripción.",
