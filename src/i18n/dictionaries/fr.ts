...
export const fr = {
  ...
  shell: {
    ...
    noConversations: "Tes discussions avec le Director apparaîtront ici.",
    untitledConversation: "Nouvelle discussion",
  ...
  landing: {
    ...
    pricingText:
      "Un crédit = une seconde de vidéo (Naturel en 1080p : 2 crédits la seconde). 3 crédits offerts à l'inscription.",
    popular: "Populaire",
    perCredit: "le crédit",
  ...
  studio: {
    ...
    placeholderDirector: "Parle de ta vidéo au Director : ton idée, pour qui, ce que tu veux obtenir…",
    placeholderDirectorBrief: "Ex. : plus drôle, ajoute un plan produit, version 30 s…",
    moreSettings: "Plus de réglages",
    modeDirector: "Director",
    modeDirectorHint: "Ton coéquipier : idées et prompt prêt à lancer",
    modeDirect: "Direct",
    ...
    swapVideoHint: "MP4, MOV ou WebM · {max} s gardées · une personne bien visible",
    swapSegment: "Passage gardé ({max} s)",
    swapTarget: "Qui remplacer ?",
    swapTargetPlaceholder: "Qui remplacer ? ex. : le combattant en short noir (facultatif)",
    swapImage: "Personnage",
    swapImageHint: "Personnage en pied, de face, sur fond uni : il gardera cette allure",
    swapUploading: "Envoi…",
    swapChange: "Changer",
    ...
    swapKeyframes: "Personnage placé sur chaque plan",
    swapShots: "Tournage et vérification des plans",
    swapRedoTitle: "Un plan raté ? Refais-le seul :",
    swapShot: "Plan {n}",
    swapShotFlagged: "À vérifier",
    swapRedo: "Refaire le plan {n} · {cost} {credits}",
    swapping: "Remplacement du personnage…",
    swapGenjutsuHint: "Environ {minutes} min · tu retrouveras la vidéo ici en revenant",
    directorStatus: "Le Director t'aide à préparer ta vidéo, tu la lances",
    ...
    briefReady: "Brief du Director",
    briefPrompt: "Prompt pour le mode Direct",
    briefToFilm: "À filmer pour le mode Remplacer",
    useInDirect: "Utiliser en mode Direct",
    useInSwap: "Passer en mode Remplacer",
    briefApplied: "Reporté, à toi de lancer",
    copy: "Copier",
    copied: "Copié",
    cancel: "Annuler",
  ...
  swapEngines: {
    genjutsu: {
      label: "Qualité max",
      hint: "Genjutsu · {rate} crédits/s · jusqu'à {max} s, coupes comprises",
    },
    kling: {
      label: "Économique",
  ...
  creditsPage: {
    ...
    title: "Crédits",
    intro:
      "Un crédit = une seconde de vidéo (Naturel en 1080p : 2 crédits la seconde). Paie seulement ce que tu utilises, sans abonnement.",
