...
export const en: Dictionary = {
  ...
  landing: {
    ...
    mockClipMeta: "12 s · 3 shots",
    mockCharacter: "Character",
    mockCharacterMeta: "1 photo",
    mockTarget: "Replace: the fighter in black shorts",
  ...
  creditsPage: {
    ...
    title: "Credits",
    intro:
      "Max quality: {max} credits per second. Budget: {budget} credits per second. Plus {sheet} credits per video for the character sheet. Pay only for what you use, no subscription.",
